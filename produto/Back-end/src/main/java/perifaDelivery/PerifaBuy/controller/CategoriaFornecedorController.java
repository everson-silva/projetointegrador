...
public class CategoriaFornecedorController implements WebMvcConfigurer {
	...
	@GetMapping("/categoria/{categoriaFornecedor}")
	public ResponseEntity<Object> getByName(@PathVariable String categoriaFornecedor){
		return ResponseEntity.ok(repository.findAllByCategoriaFornecedorContainingIgnoreCase(categoriaFornecedor));
	}
